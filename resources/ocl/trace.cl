...
static int ellipse_trace(__global t_obj *obj, t_ray ray, t_hit *hit)
{
	...
	// c = ((ray.o.x * ray.o.x) / 4.0) + ((ray.o.y * ray.o.y) / 16.0) + ((ray.o.z * ray.o.z) / 16.0) - 1.0f;

	// a = ((ray.d.x * ray.d.x) * 0.04) + ((ray.d.y * ray.d.y) * 0.04) + ((ray.d.z * ray.d.z) * 0.0625);
	// b = 2.0 * (((ray.o.x * ray.d.x) * 0.04) + ((ray.o.y * ray.d.y) * 0.04) + ((ray.o.z * ray.d.z) * 0.0625));
	// c = ((ray.o.x * ray.o.x) * 0.04) + ((ray.o.y * ray.o.y) * 0.04) + ((ray.o.z * ray.o.z) * 0.0625) - 1.0;

	// OTHER SPHEROID

	// a = (ray.d.x * ray.d.x) / 4.0 + (ray.d.y * ray.d.y) + (ray.d.z * ray.d.z);
	// b = 2.0 * ((ray.o.x * ray.d.x) / 4.0 + (ray.o.y * ray.d.y) + (ray.o.z * ray.d.z));
	// c = (ray.o.x * ray.o.x) / 4.0 + (ray.o.y * ray.o.y) + (ray.o.z * ray.o.z) - obj->radius * obj->radius;

	// a = (ray.d.x * ray.d.x) + (ray.d.y * ray.d.y) + (ray.d.z * ray.d.z);
	// b = 2.0 * ((ray.o.x * ray.d.x) + (ray.o.y * ray.d.y) + (ray.o.z * ray.d.z));
	// c = (ray.o.x * ray.o.x) + (ray.o.y * ray.o.y) + (ray.o.z * ray.o.z) - obj->radius * obj->radius;
